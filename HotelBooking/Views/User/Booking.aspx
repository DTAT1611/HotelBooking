<%@ Page Title="" Language="C#" MasterPageFile="~/Views/User/UserMaster.Master" AutoEventWireup="true" CodeBehind="Booking.aspx.cs" Inherits="HotelBooking.Views.User.Booking"  EnableEventValidation="false"%>
                ...
                <div class="row">
                    <div class="col">
                        <div class="row">
                            <div class="col">
                                 <div class="mb-3">
                            <label for="RoomeTb" class="form-label">Room</label>
                            <input type="text" class="form-control" id="RoomTb" runat="server"/>
                          </div>
                                                    <div class="mb-3">
                    <label for="DateInTb" class="form-label">DateIn</label>
